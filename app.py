...
# Load your prediction script (replace with your actual prediction logic)
...
def predictfert():
    if request.method == 'POST':
        ...
        #     desc = 'The soil of numerous crops, plants, trees, and shrubs is enriched by applying triple 17 fertilizer in the commercial setting. As a fertilizer for home usage, it may be applied to lawns, vegetable gardens, trees, shrubs, and other plants to promote growth. It may promote healthy roots, thick foliage, and protection from pests, diseases, drought, and subfreezing conditions.'
        ...
        #     desc = 'For more details: https://mahadhan.co.in/product-portfolio/enhanced-efficiency-fertilizers/smartek/mahadhan-smartek-102626'
        # else:
        #     desc = "No recommendation found."

        return render_template('recommendation.html', fertilizer=prediction)
